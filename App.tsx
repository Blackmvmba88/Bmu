      ...
      <header className="glass px-6 py-6 flex flex-col xl:flex-row justify-between items-center gap-6 sticky top-10 z-50 mx-4 rounded-b-[2rem] mt-2 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
        ...
        <div className="text-right flex items-center gap-3">
           ...
           <div className="flex flex-col items-end">
              ...
              <span className="text-[8px] font-black text-slate-600 uppercase tracking-widest">Mastery Level</span>
           </div>
        </div>
      </header>
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                 ...
                 <div className="space-y-3">
                    <div className="flex items-center gap-3">
                       ...
                       <span className="text-[10px] font-black uppercase tracking-[0.5em] accent-text">Mamba Biological Scanner</span>
                    </div>
                    <p className="text-white font-black italic text-2xl leading-tight">
                      {idleMessage || "Escaneando constantes vitales..."}
                    </p>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          {activeTab === MathTab.TELEMETRIA && (
            <div className="glass p-12 rounded-[3rem] text-center space-y-12 border-dashed border-2 border-white/10 relative overflow-hidden">
               <h3 className="text-5xl font-black mamba-text italic tracking-tighter">ESTADO BIOMÉTRICO</h3>
               <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div className="bg-white/5 p-10 rounded-[2.5rem] border border-white/5 group">
                    <span className="living-symbol text-2xl mb-4">🔋</span>
                    <span className="text-[10px] text-slate-500 font-black block mb-4 uppercase tracking-widest">Resonancia</span>
                    <span className="text-5xl font-black text-accent-primary group-hover:scale-110 transition-transform block">ALTA</span>
                  </div>
                  <div className="bg-white/5 p-10 rounded-[2.5rem] border border-white/5">
                    <span className="living-symbol text-2xl mb-4">⛓️</span>
                    <span className="text-[10px] text-slate-500 font-black block mb-4 uppercase tracking-widest">Latencia</span>
                    <span className="text-5xl font-black text-white">4ms</span>
                  </div>
               </div>
            </div>
          )}
